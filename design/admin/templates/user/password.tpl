...
<input class="halfbox password" type="password" name="newPassword" value="{$newPassword|wash}" />
</div>
...
{ezcss_require('/lib/jquery-passwordmeter/1.0/css/jquery-passwordmeter.css')}
{ezscript_require('/lib/jquery-passwordmeter/1.0/js/jquery-passwordmeter.min.js')}
...
<script type="text/javascript">
	...
	$('.password').passwordmeter({
	    submit: {level: 'strong', exclude: ['CancelButton']}
	});
</script>
{/literal}
