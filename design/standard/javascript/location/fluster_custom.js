...
Site.gmapInit = function(centerX, centerY, zoom, clustering, panoramaID) {
	...
	var hotelIcon = new google.maps.MarkerImage(
		...
		'/extension/aplutils/design/standard/images/location/markers/orange.png',
		//'../../images/location/markers/orange.png', 
	...
	var hotelIconShadow = new google.maps.MarkerImage(
		//'../../images/location/markers/orange-shadow.png',
		'/extension/aplutils/design/standard/images/location/markers/orange-shadow.png',
	...
	function createMarker(hotel, latlng) {
		...
		google.maps.event.addListener(marker, "click", function() {
			...
			var hotelinfo = function (res){
				if (res.s == 's')
				{   
					infowindow = new google.maps.InfoWindow({content: res.m});
					infowindow.open(map, marker);
				}
				else if(res.s == 'e')
				{
					infowindow = new google.maps.InfoWindow({content: $('#error_maps').html()});
					infowindow.open(map, marker);
				}                    
			}
			var marker_request_url = fluter_url_request + '/' + hotel[2];
			executeAjax('GET', marker_request_url, {}, hotelinfo);
		});
		return marker;
	}
	...
	if (clustering) {
		...
		fluster.styles = {
			0: {
				...
				image: '/extension/aplutils/design/standard/images/location/markers/fluster0.png',
				textColor: '#FFFFFF',
				width: 54,
				height: 54
			},
			10: {
				...
				image: '/extension/aplutils/design/standard/images/location/markers/fluster1.png',
				textColor: '#FFFFFF',
				width: 58,
				height: 58
			},
			20: {
				...
				image: '/extension/aplutils/design/standard/images/location/markers/fluster2.png',
				textColor: '#FFFFFF',
				width: 66,
				height: 66
			},
			40: {
				...
				image: '/extension/aplutils/design/standard/images/location/markers/fluster3.png',
				textColor: '#FFFFFF',
				width: 80,
				height: 80
			}
